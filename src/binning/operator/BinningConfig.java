...
import binning.AggregatorDescriptorRegistry;
import binning.BinManager;
import binning.BinningContext;
import binning.CompositingType;
import binning.PlanetaryGrid;
import binning.VariableContext;
import binning.support.BinningContextImpl;
import binning.support.SEAGrid;
import binning.support.VariableContextImpl;
...
//    @Parameter(defaultValue = "binning.support.SEAGrid")
    private String planetaryGrid = "binning.support.SEAGrid";
...
//    @Parameter(defaultValue = "BINNING", valueSet = {"BINNING", "MOSAICKING"})
    ...
    public BinningContext createBinningContext() {
        ...
        return new BinningContextImpl(createPlanetaryGrid(),
                                      this.binManager == null ? createBinManager(variableContext) : this.binManager,
