 ...
 */
public final class AggregatorAverage2 extends AbstractAggregator {
    ...
    public AggregatorAverage2(VariableContext varCtx, String varName, Double weightCoeff) {
        this(varCtx, varName, weightCoeff != null ? weightCoeff : 0.0, false, false);
    }

    public AggregatorAverage2(VariableContext varCtx, String varName, double weightCoeff, boolean outputCounts, boolean outputSums) {
        super(Descriptor.NAME,
                ...
                outputSums ?
                        createFeatureNames(varName, "sum", "sum_sq", "weights", outputCounts ? "counts" : null) :
                        createFeatureNames(varName, "mean", "sigma", "standard_error", outputCounts ? "counts" : null),
                Float.NaN);
        if (varCtx == null) {
    ...
    public void computeOutput(Vector temporalVector, WritableVector outputVector) {
        ...
        if (outputSums) {
            ...
            if (sumW > 0.0) {
                ...
                final double standardError = sigma / Math.sqrt(sumW);
                outputVector.set(index++, (float) mean);
                outputVector.set(index++, (float) sigma);
                outputVector.set(index++, (float) standardError);
            } else {
    ...
    public static class Descriptor implements AggregatorDescriptor {
        ...
        public Aggregator createAggregator(VariableContext varCtx, AggregatorConfig aggregatorConfig) {
            ...
            return new AggregatorAverage2(varCtx,
